    ...
    groups: [
      {
        ...
        items: [
          "Wer erreicht wen? Der Reiter „Kontakte“ zeigt Name, Telefonnummer, E-Mail-Adresse und Anschrift der Kolleginnen und Kollegen — soweit jede Person das selbst freigegeben hat.",
      ...
      },
      {
        ...
        items: [
          ...
          "Bei Handynummern kommt ein grüner WhatsApp-Knopf dazu: Er öffnet direkt das Nachrichtenfenster mit dieser Person. Bei Festnetznummern erscheint er bewusst nicht — dort gibt es kein WhatsApp, der Knopf könnte nur ins Leere führen.",
          "Neben der E-Mail-Adresse steht ein Knopf „Mail“, der das Mailprogramm mit der Adresse öffnet.",
          "Die Knöpfe stehen gesammelt unten in der Karte, damit jede Karte gleich aussieht. Nummer und Adresse selbst bleiben direkt antippbar. Wer nur seine Anschrift freigegeben hat, bekommt gar keine Knöpfe — dort gibt es nichts zu tippen.",
          "Am Handy zeigen die Knöpfe nur ihr Symbol, damit die Karten schmal bleiben."
        ]
      },
      {
        title: "Wer betreut welche Mannschaft",
        items: [
          "Der Reiter „Mannschaften“ zeigt, wer welche Mannschaft betreut — von der Ersten bis zu den Bambini, in der Reihenfolge, in der die Mannschaften auch sonst überall stehen.",
          ...
          "Wer eine Mannschaft betreut, steht hier immer mit Namen und Rolle — das gehört zur Vereinsorganisation und steht ohnehin an jedem Aushang. Telefonnummer und E-Mail-Adresse stehen nur bei den Personen, die sie freigegeben haben.",
      ...
      },
      {
        ...
        items: [
          "Über der Liste steht ein Suchfeld. Es findet Mannschaften („D2“, „Bambini“), Ligen, Jahrgänge, Namen und Rollen — und auch die freigegebenen Nummern und E-Mail-Adressen, damit sich ein Anrufer nachschlagen lässt.",
          ...
          "Gedruckt wird, was zu sehen ist. Wer erst nach „D“ sucht, bekommt ein Blatt nur mit den D-Mannschaften; der Suchbegriff steht dann oben mit drauf, damit ein Blatt mit wenigen Mannschaften nicht wie die vollständige Liste aussieht."
        ]
      },
      {
        ...
        items: [
          ...
          "Endet die Anmeldung, während die App offen ist, wird der Bildschirm geräumt — Namen, Nummern und E-Mail-Adressen verschwinden samt dem eigenen Namen oben rechts, und jeder Weg führt auf den Anmelde-Hinweis.",
